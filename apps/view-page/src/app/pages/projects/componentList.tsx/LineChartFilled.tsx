...
import {LineChartFilledDataMapping} from '../data-mapper/line-chart-filled';
import {selectThemeContext} from '../newStore/themeContextSlice';
import {getChartDataResource} from '../store/gridDataRenderSlice';

export const LineChartFilledComponent = (props: any) => {
    ...
    useEffect(() => {
        new Promise((resolve, reject) => {
            ...
            .then((response: any) => {
                ...
                const obj = LineChartFilledDataMapping(
