...
import {StackHorizontalBarChartDataMapping} from '../data-mapper/stack-horizontal-bar-chart';
import {selectThemeContext} from '../newStore/themeContextSlice';
import {getChartDataResource} from '../store/gridDataRenderSlice';

export const StackHorizontalBarChart = (props: any) => {
    ...
    useEffect(() => {
        new Promise((resolve, reject) => {
            ...
            .then((response: any) => {
                ...
                const obj = StackHorizontalBarChartDataMapping(
